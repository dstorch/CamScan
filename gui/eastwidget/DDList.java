...
/**
 *
 * @author michellemicallef
 */
public class DDList extends JList {
  ...
  public static void main(String[] a){
    JFrame f = new JFrame();
    f.add(new JScrollPane(new DDList()));
    f.setSize(300,300);
    f.setVisible(true);
  }
}
...
class MyDragListener implements DragSourceListener, DragGestureListener {
  ...
  public MyDragListener(DDList list) {
    this.list = list;
...
class MyListDropHandler extends TransferHandler {
  ...
  public MyListDropHandler(DDList list) {
    this.list = list;
  }
